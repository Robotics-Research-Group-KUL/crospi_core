...
#include "shared_memory_test_boost.hpp"
...
ConsumerNode::ConsumerNode(): Node("shared_memory_test_boost")
, time(0.0)
{
...
void ConsumerNode::construct(double periodicity_val,  triple_buffer_setpoints_type *triple_buffer_setpoints) {
