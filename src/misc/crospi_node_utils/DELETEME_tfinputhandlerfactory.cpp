...
#include "crospi_node_utils/tfinputhandler.hpp"
 ...
 */
class TFInputHandlerFactory : public InputHandlerFactory {
    rclcpp_lifecycle::LifecycleNode::SharedPtr node;

public:
    typedef std::shared_ptr<InputHandlerFactory> SharedPtr;

    TFInputHandlerFactory(rclcpp_lifecycle::LifecycleNode::SharedPtr _node)
        : node(_node)
    {
    }
...
void registerTFInputHandlerFactory(rclcpp_lifecycle::LifecycleNode::SharedPtr _node)
{
    ...
    Registry<InputHandlerFactory>::registerFactory(std::make_shared<TFInputHandlerFactory>(_node));
}
