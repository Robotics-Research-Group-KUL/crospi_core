...
void variables_to_context( 
    ...
    class FeatureVariableInitializer {
        public:
             ...
             *
             * CAVEAT:
             *  - initial robot state and feature state are extracted from the context of
             *    the task specification.
             *  - But for a physical robot, you'll want to set the robot state using
             *    setRobotState() before initializing.
             */
            virtual int initialize_feature_variables() = 0;
