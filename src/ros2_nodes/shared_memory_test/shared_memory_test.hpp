...
#include "robot_interfacing_utils/shared_mem_struct.hpp"
...
class ConsumerNode : public rclcpp::Node
{
    ...
    public:
        ConsumerNode();
        void construct(FeedbackMsg* fb, SetpointMsg* sp, double periodicity_val, triple_buffer_port_t *port_setpoints_p);
        void update();
        void consume_data();
        void safe_shutdown();
    ...
    class Producer
    {
        ...
        public:
        Producer(FeedbackMsg* fb, SetpointMsg* sp,  double periodicity_val, triple_buffer_port_t *port_setpoints_p);
