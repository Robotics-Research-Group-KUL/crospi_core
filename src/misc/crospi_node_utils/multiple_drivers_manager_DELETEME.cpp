...
namespace etasl {
    ...
    void MultipleDriversManager::on_configure(Context::Ptr ctx){
      ...
      update_joint_indices(robot_joint_names_ndx_map); //TODO: do this once at initialization since now we always give to the crospi_node all the joints of all the drivers (without taking into account what is in the etasl expressions)
