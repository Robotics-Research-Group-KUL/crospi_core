...
void simple_kinematic_simulation::update(volatile std::atomic<bool>& stopFlag)
{
    ...
    feedback_ptr->cartesian.wrench.linear.x = 4.1;
    feedback_ptr->cartesian.wrench.linear.y = 4.2;
    feedback_ptr->cartesian.wrench.linear.z = 4.3;
    feedback_ptr->cartesian.wrench.angular.x = 4.4;
    feedback_ptr->cartesian.wrench.angular.y = 4.5;
    feedback_ptr->cartesian.wrench.angular.z = 4.6;
