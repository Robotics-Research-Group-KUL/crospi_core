...
//  #include "ament_index_cpp/get_package_share_directory.hpp"
     ...
     , jsonchecker(_jsonchecker)
 {
    ...
    inputhandler_loader = std::make_shared<pluginlib::ClassLoader<etasl::InputHandler>>("crospi_core", "etasl::InputHandler");
    outputhandler_loader = std::make_shared<pluginlib::ClassLoader<etasl::OutputHandler>>("crospi_core", "etasl::OutputHandler");
